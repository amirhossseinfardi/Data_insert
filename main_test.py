...
s.driver.ensure_element_by_xpath(open_category_list,
                                 state='clickable',
                                 timeout=10).ensure_click()
# '/html/body/div[5]/div/div/div[1]/div[1]/div/div/div[1]/div/div[2]/div/div[1]'
unit_xpath = '[/html/body/div[5]/div/div/div[1]/div[1]/div/div/div[1]/div/div[2]/div/div' \
             '[contains(text(),"{temp}")]'.format(temp=list_name)
